...
-- Dumping data for table glints.keys: ~0 rows (approximately)
INSERT INTO `keys` (`id`, `user_id`, `key`, `level`, `ignore_limits`, `is_private_key`, `ip_addresses`, `date_created`) VALUES
	(1, 1, 'GlintsAP1k3y!_202i', 1, 0, 0, NULL, 1);
...
-- Dumping data for table glints.purchasehistory: ~0 rows (approximately)
...
-- Dumping data for table glints.restaurant_master: ~0 rows (approximately)
...
-- Dumping data for table glints.restaurant_menu: ~0 rows (approximately)
...
-- Dumping data for table glints.user_master: ~0 rows (approximately)
